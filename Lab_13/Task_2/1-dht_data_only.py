...
INFLUXDB_TOKEN = "AUYHQYvA-cBgdNektre1Cnya4G0Nih8xxubPsqu8B9O_N3VbkwSAGFbLvVUdiFpGPrkRxYAnSy16ufeOaxDjLA=="  # Replace with your InfluxDB token
INFLUXDB_ORG = "IOT"      # Replace with your InfluxDB organization name
INFLUXDB_BUCKET = "Lab13"  # InfluxDB bucket name

# MQTT setup
MQTT_BROKER = "10.13.44.205"  # ESP32's MQTT broker address
